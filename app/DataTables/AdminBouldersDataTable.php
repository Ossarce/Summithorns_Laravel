...
class AdminBouldersDataTable extends DataTable
{
    protected $spotId;
    protected $zoneId;
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('action', function(Boulder $boulder) {
            return '<div class="datatable-actions">
                        <a href="'. route('boulders.edit', ['spot' => $this->spotId, 'zone' => $this->zoneId, 'boulder' => $boulder->id]) .'" class="edit-btn">
                            <p>
                                <i class="bx bxs-edit bx-border"></i>
                            </p>
                        </a>
                        <a href="'. route('boulders.destroy', ['spot' => $this->spotId, 'zone' => $this->zoneId, 'boulder' => $boulder->id]) .'" class="delete-item">
                            <p>
    ...
    {
        return 'AdminBoulders_' . date('YmdHis');
    }
}
