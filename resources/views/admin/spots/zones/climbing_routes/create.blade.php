<h1>Añadir Nueva Vía</h1>
<a href="{{route('routes.index', [$spot, $zone])}}">Volver</a>
<form action="{{route('routes.store', [$spot, $zone])}}" method="POST" enctype="multipart/form-data">
    @csrf
    ...
    <button type="submit">Añadir Vía</button>
</form>
